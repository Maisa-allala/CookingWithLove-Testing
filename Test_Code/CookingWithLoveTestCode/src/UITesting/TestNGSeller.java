...
public class TestNGSeller {
	...
	//Add and publish dishes before running the test
	@Test(priority = 1)
	...
	public void SellerAddDish() throws InterruptedException {
		...
		driver.findElement(By.name("dis_name")).sendKeys("Chocolate Cupcake");
		driver.findElement(By.name("dish_detailes")).sendKeys("Chocolate cupcake with vanilla frosting");
		...
		//Change path in final submission
		fileInput.sendKeys(
				"C:\\Users\\96659\\OneDrive\\Documents\\UofM\\Winter 24\\CIS 565\\Project\\chocolate-cupcake.jpg");
		Thread.sleep(2000);
	...
	public void SellerUpdateDish() throws InterruptedException {
	    ...
	    driver.findElement(By.id("Upload_pic")).sendKeys("C:\\Users\\96659\\OneDrive\\Documents\\UofM\\Winter 24\\CIS 565\\Project\\cheesecake.jpg");
	    Thread.sleep(2000);
	...
	//Run this test after buyer places orders
	@Test(priority = 5)
