...
CREATE TABLE `orders` (
  ...
  `delivery_complete` char(1) DEFAULT NULL,
  `order_complete` char(1) DEFAULT NULL,
  PRIMARY KEY (`orderNum`),
  KEY `fk_ordersAccountID` (`accountID`),
  CONSTRAINT `fk_ordersAccountID` FOREIGN KEY (`accountID`) REFERENCES `user_account` (`accountID`)
